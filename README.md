# AlpineLinux 3.23 Packer Template for Ansible Role Testing

[![Build and Release](https://github.com/pluggero/vagrant-alpinelinux323-ansible/actions/workflows/release.yml/badge.svg)](https://github.com/pluggero/vagrant-alpinelinux323-ansible/actions/workflows/release.yml)
...
- Take a look at https://portal.cloud.hashicorp.com/vagrant/discover/pluggero/alpinelinux323-ansible to get started with the Vagrant box.
...
sha256sum alpinelinux323-virtualbox.box
...
```bash
scripts/alpinelinux323_builder.sh
```
...
This role was created in 2026 by Robin Plugge.
